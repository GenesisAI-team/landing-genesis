  ...
  return (
    <section className="relative w-full min-h-screen flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8 pt-32 pb-20 overflow-hidden">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
        ...
        <div 
            className="absolute inset-0 bg-matrix bg-cover bg-center bg-no-repeat opacity-20 mix-blend-screen"
        ></div>
      ...
      <div className="relative z-30 max-w-[90rem] w-full mx-auto text-center space-y-10 lg:space-y-12">
        ...
        <div className="flex flex-col items-center justify-center">
            <h1 className="font-inter font-black text-white tracking-tighter uppercase leading-[0.9] 
              ...
              DEJA DE PERDER <span className="text-neon inline-block"> TU TIEMPO</span>
            </h1>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-6 sm:gap-10 px-8 py-6 bg-slate-900/40 border border-white/5 rounded-2xl sm:rounded-full backdrop-blur-md mx-auto w-fit mt-8 hover:bg-slate-900/60 hover:border-white/10 transition-all duration-300 shadow-2xl">
          ...
          <div className="flex items-center gap-3 group select-none hover:scale-105 transition-transform duration-300">
            ...
            />
            <span className="font-inter font-bold text-sm text-slate-200 tracking-wide uppercase group-hover:text-emerald-300 transition-colors">AGENTES 24/7</span>
          </div>
          ...
          <div className="flex items-center gap-3 group select-none hover:scale-105 transition-transform duration-300">
            <Target 
              ...
              style={{ animationDuration: '3s' }}
            />
            <span className="font-inter font-bold text-sm text-slate-200 tracking-wide uppercase group-hover:text-cyan-300 transition-colors">0% ERROR HUMANO</span>
          </div>
          ...
          <div className="flex items-center gap-3 group select-none hover:scale-105 transition-transform duration-300">
            <Rocket 
              ...
              style={{ animationDuration: '3s' }}
            />
            <span className="font-inter font-bold text-sm text-slate-200 tracking-wide uppercase group-hover:text-purple-300 transition-colors">SETUP &lt; 7 DÍAS</span>
          </div>
