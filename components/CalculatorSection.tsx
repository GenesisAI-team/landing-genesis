...
import { ArrowRight, AlertTriangle, Crosshair, Plus, Minus } from 'lucide-react';
...
const QuantumControl: React.FC<QuantumControlProps> = ({ value, min, max, step = 1, onChange, label, unit }) => {
    // Calculate how many "blocks" are active (visual representation)
    const totalSegments = 12;
    const activeSegments = Math.round(((value - min) / (max - min)) * totalSegments);
        ...
        <div className="flex flex-col gap-1.5 md:gap-3 group">
            ...
            <div className="flex justify-between items-end">
                ...
                <div className="font-mono text-xl md:text-3xl text-white tracking-tighter">
                    {value}<span className="text-sm md:text-base text-slate-500 ml-1">{unit}</span>
                </div>
            </div>
            ...
            <div className="flex items-center gap-2 md:gap-4">
                ...
                {/* The Bar (Segments) */}
                <div className="flex-grow flex gap-1 h-8 md:h-12 relative cursor-pointer" title="Drag or Click to adjust">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="flex flex-col items-start mb-6 md:mb-20">
            <div className="flex items-center gap-2 mb-2 md:mb-4 opacity-100">
                ...
                <span className="font-mono text-sm md:text-base text-neon uppercase tracking-[0.3em] font-bold">IMPACT_ANALYSIS_V2</span>
            </div>
            ...
            <h2 className="font-inter font-black text-2xl sm:text-4xl md:text-5xl text-white uppercase tracking-tight leading-none drop-shadow-xl">
                ...
                <span className="bg-neon text-black px-2 md:px-3 py-0.5 md:py-1 mx-1 md:mx-2 transform -skew-x-12 inline-block shadow-[2px_2px_0px_rgba(255,255,255,0.2)] md:shadow-[4px_4px_0px_rgba(255,255,255,0.2)]">
                    <span className="transform skew-x-12 inline-block font-bold">NO</span>
                </span> 
                AUTOMATIZAR?
            </h2>
        </div>
                ...
                <div className="p-6 md:p-10 bg-gradient-to-b from-slate-900/80 to-black/80 backdrop-blur-md border border-white/5 md:border-y md:border-x-0 relative group overflow-hidden rounded-lg md:rounded-none transition-all duration-300 shadow-[0_0_20px_rgba(255,101,46,0.1)] hover:shadow-[0_0_40px_rgba(255,101,46,0.2)]">
                    ...
                    <div className="flex flex-col items-center text-center relative z-10">
                        <div className="flex items-center gap-2 mb-2 md:mb-4">
                            ...
                            <span className="font-mono text-sm md:text-base font-bold text-slate-300 uppercase tracking-widest">DINERO QUEMADO / MES</span>
                        </div>
                        ...
                        <button className="w-full group relative overflow-hidden px-6 py-4 md:px-8 md:py-5 bg-white text-black font-inter font-bold text-sm md:text-base tracking-wide uppercase hover:bg-neon hover:text-white transition-all duration-300 rounded-sm">
