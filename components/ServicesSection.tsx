...
const services = [
  {
    ...
    desc: "Agentes inteligentes que atienden, venden y resuelven dudas mientras tú escalas tu negocio.",
    details: "Implementamos redes neuronales de atención al cliente entrenadas específicamente con tu base de conocimientos. Estos agentes no duermen, manejan miles de interacciones simultáneas y son capaces de calificar leads, agendar reuniones y cerrar ventas directamente en tu CRM.",
    features: [
        "Latencia de respuesta < 200ms",
        "Integración nativa (Hubspot/Salesforce)",
        "Memoria de contexto a largo plazo",
  ...
  },
  {
    ...
    desc: "Conectamos tus herramientas para que los datos fluyan sin intervención humana. Eficiencia absoluta.",
    details: "Orquestamos flujos de trabajo complejos conectando todo tu stack tecnológico (Stripe, Slack, Notion, etc.). Eliminamos el error humano en tareas repetitivas de entrada de datos, sincronización y notificación, permitiendo que tu equipo se enfoque puramente en estrategia.",
    features: [
        "Webhooks bidireccionales en tiempo real",
        "Manejo de errores y reintentos automáticos",
        "Dashboards de observabilidad",
        "Reducción de OpEx del 40-60%"
    ],
  ...
  },
  {
    ...
    desc: "Diseñamos portales de entrada optimizados con IA para convertir cada visita en una venta.",
    details: "Desarrollo frontend de ultra-alto rendimiento fusionado con psicología del consumidor. Utilizamos análisis de comportamiento y A/B testing potenciado por IA para optimizar dinámicamente los copies y la estructura de la página, maximizando el ROAS de tus campañas.",
    features: [
        "Optimización Core Web Vitals (100/100)",
        "Personalización de contenido dinámica",
        "Tiempos de carga instantáneos (< 0.5s)",
        "Diseño Reactivo / Mobile-First"
    ],
...
const ServicesSection: React.FC = () => {
  ...
  return (
    <section id="servicios" className="relative w-full px-4 sm:px-6 lg:px-8 pt-24 pb-12 bg-slate-950 overflow-hidden">
       ...
       <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="text-center mb-16">
             <h3 className="font-inter font-black text-sm text-neon tracking-[0.2em] mb-4 uppercase">CÓMO TE AYUDAMOS</h3>
            ...
            >
                ...
                >
                    ...
                    <div className="mt-auto border-t border-white/5 pt-4 w-full flex justify-between items-center">
                        <span className="text-xs font-mono text-slate-500 group-hover:text-slate-400">SYS_ID_0{index + 1}</span>
                        <button className="inline-flex items-center text-xs sm:text-sm font-inter font-medium text-slate-400 group-hover:text-white transition-colors uppercase tracking-widest">
                            VER MÁS <ArrowUpRight className="ml-1 w-4 h-4 text-neon group-hover:rotate-45 transition-transform" />
                        </button>
                    </div>
                    </div>
                </div>
                ...
                <div className="w-full h-56 md:h-80 relative bg-black border-b border-slate-800 flex-shrink-0 flex items-center justify-center">
                    ...
                    <div className="absolute bottom-4 left-4 z-20">
                        <div className="inline-flex items-center gap-2 px-3 py-1 bg-black/80 border border-neon/50 backdrop-blur-md rounded-sm">
                            ...
                            <span className="font-mono text-xs text-neon uppercase font-bold">SYSTEM_DIAGNOSTIC</span>
                        </div>
                    </div>
                </div>
                                ...
                                {selectedService.features.map((feature, i) => (
                                    <li key={i} className="flex items-start gap-3 group">
                                        <div className="mt-0.5 min-w-[16px] h-4 rounded-sm bg-slate-800 flex items-center justify-center group-hover:bg-neon transition-colors">
                                            <Check size={12} className="text-white opacity-50 group-hover:opacity-100" />
                                        </div>
